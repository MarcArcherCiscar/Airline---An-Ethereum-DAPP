export class AirlineService {
    ...
    async getCustomerFlights(account){
        let customerTotalFlights = await this.getCustomerTotalFlights(account);
        let flights = [];
    ...
    async getCustomerTotalFlights(account){
        return await this.contract.customerTotalFlights(account);
    }
